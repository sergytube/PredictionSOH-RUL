%% PREDIZIONE SOH A PARTIRE DA QUESTE FEATURES 'HI1','HI2','HI3'--- MSE Error: 1.3793
...
X_train = [data_B5.features; data_B6.features;data_B18.features];
y_train = [data_B5.B5.SOH; data_B6.B6.SOH;data_B18.B18.SOH];


X_test = data_B7.features;
X_test_MSE = data_B7.features(25:end,:);
y_test = data_B7.B7.SOH(25:end,:); 

y_test_tot = data_B7.B7.SOH(1:170,:);
y_test_tot1 = data_B7.B7.SOH(1:24,:);
y_test_tot2 = data_B7.B7.SOH(51:100,:);
...
cycles = data_B7.B7.Num_cycle;  % Assumendo che ci sia una colonna Num_cycle
...
first_under_80_real = find(data_B7.B7.SOH < 80, 1);

if ~isempty(first_under_80_real) && first_under_80_real <= length(data_B7.B7.SOH) - 5
    if all(data_B7.B7.SOH(first_under_80_real+1:first_under_80_real+5) < 80)
        first_under_80_consecutive_real = first_under_80_real;
    else
        first_under_80_consecutive_real = 96; % Nessun gruppo di 5 valori consecutivi sotto l'80%
    end
else
...
save('prediction_SOH_B7', 'predictions');
