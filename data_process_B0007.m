...
for i = 1: numCicli
    cycleType = B0007.cycle(i).type;
    cycleData = B0007.cycle(i).data;
    cycleTime = B0007.cycle(i).time; 
    cycleAmbient = B0007.cycle(i).ambient_temperature;
