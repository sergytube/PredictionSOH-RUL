...
predictions_SOH_B5 = prediction_SOH_B5.predictions_B5;
predictions_SOH_B6 = prediction_SOH_B6.predictions_B6;
predictions_SOH_B7 = prediction_SOH_B7.predictions_B7;
predictions_SOH_B18 = prediction_SOH_B18.predictions_B18;
...
index_positive_RUL_train_B5 = data_B5.B5.RUL > 0;
X_train_RUL_B5 = [predictions_SOH_B6(index_positive_RUL_train_B5), cycles_B6(index_positive_RUL_train_B5); predictions_SOH_B7(index_positive_RUL_train_B5), cycles_B7(index_positive_RUL_train_B5); predictions_SOH_B18(index_positive_RUL_train_B5), cycles_B18(index_positive_RUL_train_B5)];
...
X_test_B5 = [predictions_SOH_B5(index_positive_RUL_test_B5), cycles_B5(index_positive_RUL_test_B5)];
...
index_positive_RUL_train_B6 = data_B6.B6.RUL > 0;
X_train_RUL_B6 = [predictions_SOH_B5(index_positive_RUL_train_B6), cycles_B5(index_positive_RUL_train_B6); predictions_SOH_B7(index_positive_RUL_train_B6), cycles_B7(index_positive_RUL_train_B6); predictions_SOH_B18(index_positive_RUL_train_B6), cycles_B18(index_positive_RUL_train_B6)];
y_train_RUL_B6 = [data_B5.B5.RUL(index_positive_RUL_train_B6); data_B7.B7.RUL(index_positive_RUL_train_B6); data_B18.B18.RUL(index_positive_RUL_train_B6)];

% Addestra il modello GPR
gprMdl_RUL_B6 = fitlm(X_train_RUL_B6, y_train_RUL_B6);

% Utilizza le previsioni della SOH e i numeri di ciclo come feature per la previsione del RUL su B18
index_positive_RUL_test_B6 = data_B6.B6.RUL > 0;
X_test_B6 = [predictions_SOH_B6(index_positive_RUL_test_B6), cycles_B6(index_positive_RUL_test_B6)];
y_test_B6 = data_B6.B6.RUL(index_positive_RUL_test_B6);

%% VALUTAZIONE DEL MODELLO SU B6

% Effettua previsioni del RUL su B18 utilizzando le previsioni della SOH come feature
predictions_RUL_B6_with_predicted_SOH = predict(gprMdl_RUL_B6, X_test_B6);
...
index_positive_RUL_train_B7 = data_B7.B7.RUL > 0;
X_train_RUL_B7 = [predictions_SOH_B5(index_positive_RUL_train_B7), cycles_B5(index_positive_RUL_train_B7), ...
                  data_B5.B5.minCurrent(index_positive_RUL_train_B7), data_B5.B5.avgCurrent(index_positive_RUL_train_B7), ...
                  data_B5.B5.varCurrent(index_positive_RUL_train_B7), data_B5.B5.maxCurrent(index_positive_RUL_train_B7); ...
                  predictions_SOH_B6(index_positive_RUL_train_B7), cycles_B6(index_positive_RUL_train_B7), ...
                  data_B6.B6.minCurrent(index_positive_RUL_train_B7), data_B6.B6.avgCurrent(index_positive_RUL_train_B7), ...
                  data_B6.B6.varCurrent(index_positive_RUL_train_B7), data_B6.B6.maxCurrent(index_positive_RUL_train_B7); ...
                  predictions_SOH_B18(index_positive_RUL_train_B7), cycles_B18(index_positive_RUL_train_B7), ...
                  data_B18.B18.minCurrent(index_positive_RUL_train_B7), data_B18.B18.avgCurrent(index_positive_RUL_train_B7), ...
                  data_B18.B18.varCurrent(index_positive_RUL_train_B7), data_B18.B18.maxCurrent(index_positive_RUL_train_B7)];y_train_RUL_B7 = [data_B5.B5.RUL(index_positive_RUL_train_B7); data_B6.B6.RUL(index_positive_RUL_train_B7); data_B18.B18.RUL(index_positive_RUL_train_B7)];

% Addestra il modello GPR
gprMdl_RUL_B7 = fitlm(X_train_RUL_B7, y_train_RUL_B7);

% Utilizza le previsioni della SOH e i numeri di ciclo come feature per la previsione del RUL su B18
index_positive_RUL_test_B7 = data_B7.B7.RUL > 0;
X_test_B7 = [predictions_SOH_B7(index_positive_RUL_test_B7), cycles_B7(index_positive_RUL_test_B7), ...
             data_B7.B7.minCurrent(index_positive_RUL_train_B7), data_B7.B7.avgCurrent(index_positive_RUL_train_B7), ...
             data_B7.B7.varCurrent(index_positive_RUL_train_B7), data_B7.B7.maxCurrent(index_positive_RUL_train_B7)];y_test_B7 = data_B7.B7.RUL(index_positive_RUL_test_B7);
...
index_positive_RUL_train_B18 = data_B18.B18.RUL > 0;
X_train_RUL_B18 = [predictions_SOH_B5(index_positive_RUL_train_B18), cycles_B5(index_positive_RUL_train_B18); predictions_SOH_B6(index_positive_RUL_train_B18), cycles_B6(index_positive_RUL_train_B18); predictions_SOH_B7(index_positive_RUL_train_B18), cycles_B7(index_positive_RUL_train_B18)];
y_train_RUL_B18 = [data_B5.B5.RUL(index_positive_RUL_train_B18); data_B6.B6.RUL(index_positive_RUL_train_B18); data_B7.B7.RUL(index_positive_RUL_train_B18)];

% Addestra il modello GPR
gprMdl_RUL_B18 = fitlm(X_train_RUL_B18, y_train_RUL_B18);

% Utilizza le previsioni della SOH e i numeri di ciclo come feature per la previsione del RUL su B18
index_positive_RUL_test_B18 = data_B18.B18.RUL > 0;
X_test_B18 = [predictions_SOH_B18(index_positive_RUL_test_B18), cycles_B18(index_positive_RUL_test_B18)];
y_test_B18 = data_B18.B18.RUL(index_positive_RUL_test_B18);
...
% Creazione dei vettori contenenti gli errori MSE, RMSE e MAE per ogni batteria
mseErrors_RUL = [mseError_B5_with_predicted_SOH, mseError_B6_with_predicted_SOH, mseError_B7_with_predicted_SOH, mseError_B18_with_predicted_SOH];
