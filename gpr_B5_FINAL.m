...
X_train = [data_B6.features; data_B7.features;data_B18.features];
y_train = [data_B6.B6.SOH; data_B7.B7.SOH;data_B18.B18.SOH];


X_test = data_B5.features;
X_test_MSE = data_B5.features(25:end,:);
y_test = data_B5.B5.SOH(25:end,:); 

y_test_tot = data_B5.B5.SOH(1:170,:);
y_test_tot1 = data_B5.B5.SOH(1:24,:);
y_test_tot2 = data_B5.B5.SOH(51:100,:);
...
cycles = data_B5.B5.Num_cycle;  % Assumendo che ci sia una colonna Num_cycle
RUL = data_B5.B5.TOTAL_TIME;
...
first_under_80_real = find(data_B5.B5.SOH < 80, 1);

if ~isempty(first_under_80_real) && first_under_80_real <= length(data_B5.B5.SOH) - 5
    if all(data_B5.B5.SOH(first_under_80_real+1:first_under_80_real+5) < 80)
...
save('prediction_SOH_B5', 'predictions');
