...
for i = 1: numCicli
    cycleType = B0006.cycle(i).type;
    cycleData = B0006.cycle(i).data;
    cycleTime = B0006.cycle(i).time; 
    cycleAmbient = B0006.cycle(i).ambient_temperature;
